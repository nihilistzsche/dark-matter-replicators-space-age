...
repltech_item("y-toxic-dust", "ore", 
	{
		{target = "sulfuric-acid", type = "item", multiplier = 10/12},
		{target = "water", type = "item", multiplier = -20/12},
		{target = "yuoki-archaeology-wash", type = "var", multiplier = -3.5/12}
	}
)
