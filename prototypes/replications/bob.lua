...
--resetting the variables, idk
replvar("", 1) --Assembling machine 4 (the new most efficient one)
replvar("smelting", 1) --Electric chemical mixing furnace 2
replvar("oil-processing", 1) --Oil refinery 4
replvar("chemistry", 1) --Chemical plant 4
--Processing costs for new forms of processing
replvar("air-pump", 1) --Air Pump 4
replvar("distillery", 1) --Distillery
replvar("electrolysis", 1) --Electrolyser 4
replvar("electronics", 1) --Electronics machine 3
replvar("electronics-machine", 1) --Electronics Machine 3
replvar("mixing-furnace", 1) --Electric chemical mixing furnace 2
replvar("chemical-furnace", 1) --Electric chemical mixing furnace 2
