...
if mods["space-exploration"] then
	...
	if
		not recipes["dmrsa-repl-production-science-pack"]
	...
	then
		...
		if replaced_production_science_pack then
			recipes["dmrsa-repl-production-science-pack"].energy_required = recipes["dmrsa-repl-production-science-pack"].energy_required
				* 75
		end
		if replaced_utility_science_pack then
			recipes["dmrsa-repl-utility-science-pack"].energy_required = recipes["dmrsa-repl-utility-science-pack"].energy_required
				* 75
		end
		--this can be removed somehow, so let it go I guess.
		if recipes["dmrsa-repl-space-science-pack"] then
			recipes["dmrsa-repl-space-science-pack"].energy_required = recipes["dmrsa-repl-space-science-pack"].energy_required
				* 40
		end
	end
end
